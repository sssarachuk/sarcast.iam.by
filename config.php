...
define('WHATSAPP_АККАУНТ', 'https://api.whatsapp.com/send?phone=375296039949&text=Здравствуйте! Меня интересует стоимость ваших услуг');
...
define('ВОПРОС_1_НА_ЭМЕЙЛ', 'Насколько вам было комфортно со мной?');
define('ВОПРОС_2_НА_ЭМЕЙЛ', 'Три лучших качества фотографа');
define('ВОПРОС_3_НА_ЭМЕЙЛ', 'Чем вас зацепили фотографии?');
