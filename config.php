...
define('ВОПРОС_1_НА_ЭМЕЙЛ', 'Поделитесь впечатлением от мини-серии фотографий');
//2-5 вопросы только для клиента
define('ВОПРОС_2_НА_ЭМЕЙЛ', 'Распишите как вам работалось с фотографом');
define('ВОПРОС_3_НА_ЭМЕЙЛ', 'Три лучших качества фотографа');
define('ВОПРОС_4_НА_ЭМЕЙЛ', 'Какие качества стоит улучшить?');
define('ВОПРОС_5_НА_ЭМЕЙЛ', 'Кто еще работал кроме фотографа? (ссылки для их рекламы на этом сайте)');
