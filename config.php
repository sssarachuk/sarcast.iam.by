...
define('К_ИМЯ_САЙТА', 'Свадебный и семейный фотограф Сергей Сарачук с любовью к путешествиям');
...
define('К_ЗАГОЛОВОК_ГЛАВНОЙ_СТРАНИЦЫ',
       'Свадебный и портретный фотограф в Минске Гомеле Мозыре');
//Заголовок H1
...
define('К_ОПИСАНИЕ_СТРАНИЦЫ_ЦЕН',
       '[Нужен фотограф?] Цены от 30уе/час ☆ ❺ лет опыта ☆ ❸ подарка ✈ Выезд по городам Беларуси и Европы ☎ Онлайн-чат ✓ Заходите!');
