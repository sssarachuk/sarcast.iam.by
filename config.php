...
define('ВОПРОС_1_НА_ЭМЕЙЛ', 'Ваше впечатление от фотографий (в 2-3 предложения)');
//2-5 вопросы только для клиента
define('ВОПРОС_2_НА_ЭМЕЙЛ', 'Что вам запомнилось при работе с фотографом?');
define('ВОПРОС_3_НА_ЭМЕЙЛ', 'Три лучших качества фотографа');
define('ВОПРОС_4_НА_ЭМЕЙЛ', 'Ваши замечания по работе фотографа или сайта');
define('ВОПРОС_5_НА_ЭМЕЙЛ', 'Укажите ссылки на других специалистов (кто работал)');
