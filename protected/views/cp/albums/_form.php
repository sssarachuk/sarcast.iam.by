...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<small>(одно имя файла на строку, 1я строка будет заглавной фото)</small><br>
		<small>(быстрее всего закачать 1 фото, остальные через FTP, и названия скопировать сюда)</small>
	</div>
	<br>
	<div class="row">
