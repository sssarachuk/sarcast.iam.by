...
?>
    ...
    <section class="breadcrumbs-custom bg-image" style="background-image: url(/images/breadcrumbs-image.jpg);">
        <div class="shell">
          <h1 class="breadcrumbs-custom__title"><?php echo К_ЗАГОЛОВОК2_СКРЫТЫХ_СТРАНИЦ; ?></h1>
            <ul class="breadcrumbs-custom__path">
            <li><a href="/">Главная</a></li>
            <li class="active"><?php echo К_ЗАГОЛОВОК2_СКРЫТЫХ_СТРАНИЦ; ?></li>
          </ul>
        </div>
      </section>
        ...
        <div class="isotope isotope--loaded" data-isotope-layout="fitRows" data-isotope-group="gallery" data-lightgallery="group" style="position: relative; height: 918px;">
            <div class="row">
              ...
              <div class="col-xs-12 col-sm-6 col-md-4 isotope-item">
                  ...
                  <div class="row"><a href="/album/<?=$album->slug;?>"><div class="col-sm-12 heading-4" style="min-height: 60px;"><?=$album->h1;?> (<?=count($images_url);?> фото)</div></a></div>
                </div>
